...
if __name__ == '__main__':
    ...
    input_file = '/datasets/restaurants/fodors_zagats_concatenated.csv'
    output_file = '/dedupe/output/restaurants_output.csv'
    settings_file = '/dedupe/output/restaurants_settings'
    training_file = '/dedupe/output/restaurants_training.json'
